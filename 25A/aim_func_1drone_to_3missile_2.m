function [all_shield_time, shield_time1, shield_time2, shield_time3] = aim_func_1drone_to_3missile_2(drone_speed, alpha, ...
...
g = 9.8;
drone_pos0 = [12000,1400,1400];  % ========需要修改无人机位置=======
...
% 第一个导弹的被遮挡时间
[shield_time1, missile1_shield_time_array]= cal_3bomb_to_1missile(t_sim, missile1_pos0, missile1_vel, bomb_explode_pos1,bomb_explode_pos2,bomb_explode_pos3, ...
                                                t_start1,t_end1,t_start2,t_end2,t_start3,t_end3, t_explode1, t_explode2, t_explode3,dt);
[shield_time2, missile2_shield_time_array]= cal_3bomb_to_1missile(t_sim, missile2_pos0, missile2_vel, bomb_explode_pos1,bomb_explode_pos2,bomb_explode_pos3, ...
                                                t_start1,t_end1,t_start2,t_end2,t_start3,t_end3, t_explode1, t_explode2, t_explode3,dt);
[shield_time3, missile3_shield_time_array] = cal_3bomb_to_1missile(t_sim, missile3_pos0, missile3_vel, bomb_explode_pos1,bomb_explode_pos2,bomb_explode_pos3, ...
                                                t_start1,t_end1,t_start2,t_end2,t_start3,t_end3, t_explode1, t_explode2, t_explode3,dt);
...
figure; 
% 绘制四条线，并保存句柄
plot(missile1_shield_time_array, ones(length(missile1_shield_time_array)), 'r.', 'LineWidth',2, 'DisplayName', 'Smoke Bomb1');
hold on;
plot(missile2_shield_time_array, ones(length(missile2_shield_time_array))+0.2, 'b.', 'LineWidth',2, 'DisplayName', 'Smoke Bomb2');
plot(missile3_shield_time_array, ones(length(missile3_shield_time_array))+0.4, 'k.', 'LineWidth',2, 'DisplayName', 'Smoke Bomb3');

grid on;
% 设置y轴标签
yticks([1, 1.2, 1.4]);
yticklabels({'Missile1', 'Missile2', 'Missile3'});
