function [all_shield_time,  shield_time1, shield_time2, shield_time3] = aim_func_FY2_2(drone_speed, alpha, ...
...
g = 9.8;
drone_pos0 = [17800,0,1800];  % =====修改无人机位置=====
...
% 无人机
% =====需要修改方向======
drone_dir = [-sign(alpha) * cos(alpha), abs(sin(alpha))];  % 范围[0,pi]
...
[missile1_shield_time, missile1_shield_time_bomb1, missile1_shield_time_bomb2, missile1_shield_time_bomb3]= cal_3bomb_to_1missile(t_sim, missile1_pos0, missile1_vel, bomb_explode_pos1,bomb_explode_pos2,bomb_explode_pos3, ...
                                                t_start1,t_end1,t_start2,t_end2,t_start3,t_end3, t_explode1, t_explode2, t_explode3,dt);
[missile2_shield_time, missile2_shield_time_bomb1, missile2_shield_time_bomb2, missile2_shield_time_bomb3]= cal_3bomb_to_1missile(t_sim, missile2_pos0, missile2_vel, bomb_explode_pos1,bomb_explode_pos2,bomb_explode_pos3, ...
                                                t_start1,t_end1,t_start2,t_end2,t_start3,t_end3, t_explode1, t_explode2, t_explode3,dt);
[missile3_shield_time, missile3_shield_time_bomb1, missile3_shield_time_bomb2, missile3_shield_time_bomb3] = cal_3bomb_to_1missile(t_sim, missile3_pos0, missile3_vel, bomb_explode_pos1,bomb_explode_pos2,bomb_explode_pos3, ...
                                                t_start1,t_end1,t_start2,t_end2,t_start3,t_end3, t_explode1, t_explode2, t_explode3,dt);

all_shield_time = missile1_shield_time + missile2_shield_time + missile3_shield_time;

% 判断烟雾弹1是否对导弹123有遮挡
if_shield_bomb1 = [missile1_shield_time_bomb1,missile2_shield_time_bomb1,missile3_shield_time_bomb1];
if_shield_bomb2 = [missile1_shield_time_bomb2,missile2_shield_time_bomb2,missile3_shield_time_bomb2];
if_shield_bomb3 = [missile1_shield_time_bomb3,missile2_shield_time_bomb3,missile3_shield_time_bomb3];

disp('===烟雾弹1===');
disp(if_shield_bomb1);
disp('===烟雾弹2===');
disp(if_shield_bomb2);
disp('===烟雾弹3===');
disp(if_shield_bomb3);
...
shield_time1 = sum(if_shield_bomb1);
shield_time2 = sum(if_shield_bomb2);
shield_time3 = sum(if_shield_bomb3);
