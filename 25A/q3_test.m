...
alpha_bound = [-pi/20,pi/20];  % 无人机飞行角度范围
t_deploy1_bound = [0,8];  % 无人机开始起飞到投掷第1枚烟雾弹
t_deploy2_bound = [0,8];  % 无人机开始起飞到投掷第2枚烟雾弹
t_deploy3_bound = [0,8];  % 无人机开始起飞到投掷第3枚烟雾弹
t_explode_delay1_bound = [0,9];  % 投掷后爆炸时间间隔范围1 s
t_explode_delay2_bound = [0,9];  % 投掷后爆炸时间间隔范围2 s
t_explode_delay3_bound = [0,9];  % 投掷后爆炸时间间隔范围3 s
